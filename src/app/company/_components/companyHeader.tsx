...
const CompanyHeader = ({ instrument, instrumentId, symbol, name, currency, price, change, lastUpdate }: CompanyHeaderProps) => {
  return (
    <header className="bg-gradient-to-r from-black via-slate-900 to-black p-6 border-l-4 border-cyan-500 shadow-[0_0_15px_rgba(34,211,238,0.3)] w-full flex flex-grow justify-between items-start">
      ...
      <div>
        <WatchButton instrument={instrument} instrumentId={instrumentId} includeText={true} />
      </div>
    </header>
  )
}
